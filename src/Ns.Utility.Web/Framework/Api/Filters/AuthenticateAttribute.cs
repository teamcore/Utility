...
namespace Ns.Utility.Web.Framework.Api.Filters
{
    public class AuthenticateAttribute : ActionFilterAttribute
    {
        ...
        private static bool IsDateValidated(string timestampString)
        {
            ...
            bool isDateTime = DateTime.TryParseExact(timestampString, "U", null, DateTimeStyles.AdjustToUniversal, out timestamp);
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            if (!isAuthenticated)
            {
                //actionContext.Response = actionContext.Request.CreateErrorResponse(HttpStatusCode.Unauthorized, "This request is not authorized to access this resource.");
