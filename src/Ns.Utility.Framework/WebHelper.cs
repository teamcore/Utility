    ...
    public class WebHelper : IWebHelper
    {
        ...
        public virtual string GetUrlReferrer()
        {
            ...
            try
            {
                ...
                {
                    referrerUrl = httpContext.Request.UrlReferrer.ToString();
                }
            }
            catch (Exception)
            {
        ...
        public virtual bool SslEnabled()
        {
            ...
            try
            {
                useSsl = !String.IsNullOrEmpty(ConfigurationManager.AppSettings["UseSSL"]) 
        ...
        public virtual string ModifyQueryString(string url, string queryStringModification, string anchor)
        {
            ...
            if (url.Contains("#"))
            {
                str2 = url.Substring(url.IndexOf("#", StringComparison.OrdinalIgnoreCase) + 1);
                url = url.Substring(0, url.IndexOf("#", StringComparison.OrdinalIgnoreCase));
            }
            if (url.Contains("?"))
            {
                str = url.Substring(url.IndexOf("?", StringComparison.OrdinalIgnoreCase) + 1);
                url = url.Substring(0, url.IndexOf("?", StringComparison.OrdinalIgnoreCase));
            }
        ...
        public virtual T QueryString<T>(string name)
        {
            ...
            if (httpContext != null && httpContext.Request.QueryString[name] != null)
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new TechnicalException("System needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
