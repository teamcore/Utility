...
namespace Aprimo.Utility.Framework.Common
{
    /// <summary>
    ...
    public sealed class GenericComparer<T> : IComparer<T>
    {
        ...
        private readonly SortOrder sortingOrder;
        ...
        public int Compare(T x, T y)
        {
            ...
            return sortingOrder == SortOrder.Ascending ? (obj1.CompareTo(obj2)) : (obj2.CompareTo(obj1));
        }
        #endregion
    }
}
