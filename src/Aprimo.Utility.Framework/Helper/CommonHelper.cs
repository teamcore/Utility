...
using System.Web;
using Aprimo.Utility.Framework.Common;
    ...
    public class CommonHelper
    {
        ...
        public static AspNetHostingPermissionLevel GetTrustLevel()
        {
            if (!trustLevel.HasValue)
            {
                ...
                //determine maximum
                foreach (AspNetHostingPermissionLevel hostingTrustLevel in
                        new[] {
                            ...
                            })
                {
                    try
                    {
                        new AspNetHostingPermission(hostingTrustLevel).Demand();
                        trustLevel = hostingTrustLevel;
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new FunctionalException(string.Format("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType));
            if (!pi.CanWrite)
                throw new FunctionalException(string.Format("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType));
        ...
        //TODO move this property to Config
