...
namespace Aprimo.Utility.Framework.Caching
{
    public class PerRequestCacheProvider : ICacheProvider
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PerRequestCacheProvider"/> class.
        /// </summary>
        /// <param name="context">The context.</param>
        public PerRequestCacheProvider(HttpContextBase context)
        {
        ...
        public void Set(string key, object data, CacheItemPolicy policy)
        {
            ...
            if (data != null)
            {
                if (items.Contains(key))
                    ...
                    items.Add(new CacheItem(key, data), policy);
            }
        }
